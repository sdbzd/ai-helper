...
use crate::automation::{LoginOutcome, LoginScript};
use crate::secure_storage::CredentialVault;
...
pub struct IpcHandler<'a> {
    ...
    pub automation: &'a crate::automation::AutomationEngine,
}
    ...
    pub fn handle(&self, req: IpcRequest) -> anyhow::Result<IpcResponse> {
        match req {
            ...
            IpcRequest::StoreCredential {
                ...
                self.vault.store(crate::secure_storage::CredentialEntry {
                    id,
                    username,
                    secret,
                    token: None,
